...
| [getDisplayValue](#getDisplayValue) (String) | Returns the display value of the specified parameter. Returns an empty string if the request, instance, and portal do not exist. Returns null if the request exists but has no such parameter, or the instance exists but has no such parameter.|
...
| [getRecordElements](#getRecordElements) (Object data, GlideRecord from, String names): void | Copies the record element's name, display value, and value into the data parameter. |
| [getWidgetScope](#getWidgetScope) (String instanceId) : Object | Used for including a widget inside another widget (eg. menu inside header). InstanceId can be a widget instance sys_id or ID. Returns a widget, or an empty object if the instanceID is empty or invalid.|
| [getWidgetFromInstance](#getWidgetFromInstance) (String instanceID) | Returns a widget from the specified instance.|
| [getWidget](#getWidget) (String widgetID, Object widgetParams) | Used for embedding a widget inside another widget. |
| [getRelatedList](#getRelatedList) (String tableName, String foreignKey)|Gets the related list of data for a instance. Returns [{}, {}, ...]|
...
| [getFilterBreadcrumbs](#getFilterBreadcrumbs) (String table, String query, String fixedQuery): Array | Returns an array of objects where each object contains the breadcrumb label, value, and flags for if fixed and if removed. |
| [getRecordVariables](#getRecordVariables) (GlideRecord gr) | Returns the task variables for a requested catalog item. | 
...
| logSearch ( String table, String terms, **Int** count ): void | Adds a record to the Service Portal statistics log, specifically for a search|
